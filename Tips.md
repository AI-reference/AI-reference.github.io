...
So essentially, read the paper from the ends inward for increasingly specific information. The start and end are more global and are written on a high level, in the context of the problem they want to solve, whereas the center of the paper contains the details.
...
When you write a paper you will often use results or methods from other researchers. All information of any kind that you take from another research or any resource other than yourself you should cite in your paper. Citing the work of other people can be done in different styles. Citing, or referencing, comes down to briefly noting a piece of text is obtained from another author right after the content and thoroughly referencing the author and their work at the end of the paper in the reference section. Writing these long references can be a pain, but in the best paper writing software LaTeX, this can be automated.

**LaTeX**

LaTeX is kind of a programming language (if you take a very broad definition of the word), in which you can write your paper's layout and content to make it look very professional. You can write your paper in LaTeX on the website [Overleaf](https://www.overleaf.com){:target="_blank"}. In LaTeX you can automatically create a reference page in any reference style using BibTeX. More information on LaTeX can be found on the [Tools page](Tools.md#latex).
